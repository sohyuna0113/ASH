						...
						<div class="box box-primary">
							...
							<div class="box-body">
								<div class="form-group">
									<label for="exampleInputEmail1" style="width:40%; margin-right:10px;" >First Category</label>
									<label for="exampleInputEmail1" style="width:40%;" >Second Category</label> <br />
									<span class="form-control" style="width:40%; margin-right:10px; display:inline-block;">${vo.categ_prt}</span>
									<span class="form-control" style="width:40%;  display:inline-block;">${vo.categ_now}</span>
									
								</div>
								<div class="form-group">
									<label for="exampleInputEmail1">Product Name</label> 
									<span class="form-control">${vo.pd_name}</span>
								</div>
								<div class="form-group">
									<label for="exampleInputEmail1">Company</label> 
									<span class="form-control">${vo.pd_company}</span>
								</div>
								<div class="form-group">
									...
									<span class="form-control" style="width:40%; margin-right:10px; display:inline-block;">${vo.pd_price}</span>
									<span class="form-control" style="width:40%; display:inline-block;">${vo.pd_dc}</span>
								</div>
								<div class="form-group">
								...
								<div class="form-group">
									...
									<span class="form-control"><c:out value="${vo.pd_img}" /></span>
									<!-- TODO: 이미지파일 처리 필요 -->
									<!-- 
									<input
								...
								<div class="form-group">
									...
									<span class="form-control" style="width:40%; margin-right:10px; display:inline-block;">${vo.pd_amount}</span>
									<span class="form-control" style="width:40%; display:inline-block;">${vo.pd_buy}</span>
								</div>
								<div class="form-group">
							...
							<div class="box-footer">
								...
								<button id="btn_list" type="button" class="btn btn-primary" >GO to List</button>
							</div>
