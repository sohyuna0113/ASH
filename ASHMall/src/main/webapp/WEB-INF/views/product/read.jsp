...
<script>
	$(document).ready(function(){
		...
		$('#btn_list').on("click", function(){
			location.href="/product/list${pm.makeQuery(pm.cri.page)}&categ_now=${vo.categ_now}"
		});
				...
				<div class="row">
					...
					<div class="col-md-12">
						...
						<div class="box box-primary">
							...
							<%-- 상품 상세 정보 출력 --%>
							<div class="box-body">
								<div class="form-group container" style="margin:50px 0px; height:350px;" >
						    	...
						    	<form role="form" action="modifyReview" method="post">
									 	...
									 	<ul class="timeline" style="list-style:none;">
											...
											<li class="time-label" id="repliesDiv">
												<span class="btn btn-default">
											    	Review <small id='replycntSmall'> [ ${totalReview} ] </small>
											    </span>
